...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                @if ($item->id)
                <form class="needs-validation" action="{{ route('admin.about.update', $item->id) }}" method="POST" enctype='multipart/form-data' novalidate>
                    <input type="hidden" name="_method" value="PUT">
                    @else
                    <form class="needs-validation" action="{{ route('admin.about.store') }}" method="POST" enctype='multipart/form-data' novalidate>
    ...
    <div class="col-md-12">
        ...
        <a class="btn btn-danger pull-right text-white" href="{{ route('admin.about.index') }}">@lang('admin.Cancel') <i class="icon-arrow-left-bold"></i></a>
    </div>
</div>
</form>
</div>
