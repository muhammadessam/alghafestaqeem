...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">@lang('admin.Entities') <span class="badge badge-danger">{{ $result['counts'] ?? '0' }}</span>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    ...
                                    <a class="btn btn-sm btn-warning" href="{{ route('admin.entities.edit', $item->id) }}">
                                        <i class="text-white icon-note"></i>
                                    </a>
                                    @endif
                                    @if (can('entities.destroy'))
                                    <form action="{{ route('admin.entities.destroy', $item->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Delete? Are you sure?');">
                                        {{ csrf_field() }}
