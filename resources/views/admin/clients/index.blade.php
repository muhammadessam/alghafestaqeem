...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">@lang('admin.Clients') <span class="badge badge-danger">{{ $result['counts'] ?? '0' }}</span>
                    ...
                    <table class="table table-sm table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    @if (can('clients.edit'))
                                    <a class="btn btn-sm btn-warning" href="{{ route('admin.clients.edit', $item->id) }}">
                                        <i class="text-white icon-note"></i>
                                    </a>
                                    @endif
                                    @if (can('clients.delete'))
                                    <form action="{{ route('admin.clients.destroy', $item->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Delete? Are you sure?');">
                                        {{ csrf_field() }}
