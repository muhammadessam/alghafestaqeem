    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                @if ($item->id)
                <form class="needs-validation" action="{{ route('admin.counters.update', $item->id) }}" method="POST" enctype='multipart/form-data' novalidate>
                    <input type="hidden" name="_method" value="PUT">
                    @else
                    <form class="needs-validation" action="{{ route('admin.counters.store') }}" method="POST" enctype='multipart/form-data' novalidate>
                        @endif
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="1" required class="form-control @if ($errors->has('counter')) is-invalid @endif" name="counter" value="{{ old('counter', $item->counter) ?? '0' }}" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @if ($errors->has('sign')) is-invalid @endif" name="sign" value="{{ old('sign', $item->sign) ?? '+' }}" />
                                            @if ($errors->has('sign'))
                            ...
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-danger pull-right text-white" href="{{ route('admin.counters.index') }}">@lang('admin.Cancel') <i class="icon-arrow-left-bold"></i></a>
                            </div>
                        </div>
                    </form>
            </div>
