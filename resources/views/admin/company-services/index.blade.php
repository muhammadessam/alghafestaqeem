                                            ...
                                            <td class="text-left">
                                                @if (can('company-services.edit'))
                                                    ...
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('admin.company-services.edit', $item->id) }}">
                                                        <i class="text-white icon-note"></i>
                                                    </a>
                                                @endif
                                                @if (can('company-services.delete'))
                                                    <form
                                                        action="{{ route('admin.company-services.destroy', $item->id) }}"
