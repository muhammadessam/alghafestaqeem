...
@section('tab_name', __('admin.CompanyServices'))
@section('css')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-name">@lang('admin.CompanyServices') /
                    @if ($item->id)
                ...
                <hr>
                @if ($item->id)
                <form class="needs-validation" action="{{ route('admin.company-services.update', $item->id) }}" method="POST" enctype='multipart/form-data' novalidate>
                    <input type="hidden" name="_method" value="PUT">
                    @else
                    <form class="needs-validation" action="{{ route('admin.company-services.store') }}" method="POST" enctype='multipart/form-data' novalidate>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            ...
                                            <textarea id="description-field" rows="12" class="form-control @if ($errors->has('description')) is-invalid @endif" name='description'>{{ $item->description ?? old('description') }}</textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-danger pull-right text-white" href="{{ route('admin.company-services.index') }}">@lang('admin.Cancel') <i class="icon-arrow-left-bold"></i></a>
                            </div>
                        </div>
                    </form>
            </div>
