...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> @lang('admin.company_transactions')
                ...
                @include('admin.evaluation.transactions.company.search')

                @if ($result['items']->count())
                <div class="table-responsive">
                    <table class="table table-sm " id="example1">
                        @include('admin.evaluation.transactions.company.table')
                    </table>
                </div>
                @else
