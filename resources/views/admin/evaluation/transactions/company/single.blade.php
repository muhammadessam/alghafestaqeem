...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"> @lang('admin.EvaluationTransaction') 
                        <span class="badge badge-danger">{{ $result['company']['title']}}</span>
                    ...
                    @include('admin.evaluation.transactions.company.singlesearch')

                    @if ($result['items']->count())
                        <div class="table-responsive">
                            <table class="table table-sm " id="evalution">
                                @include('admin.evaluation.transactions.table1')
                            </table>
                        </div>
                    @else
