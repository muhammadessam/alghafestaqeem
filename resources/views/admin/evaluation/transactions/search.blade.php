...
<form action="{{ route('admin.evaluation-transactions.index') }}"  method="GET">
    <div class="row">
        ...
        <!--      <button class="btn btn-primary btn-block"  type="submit" formaction="{{ route('admin.evaluation-transactions.index') }}">@lang('admin.Search')</button>-->
        <!--    <button  class="btn btn-primary btn-block" type="submit" formaction="{{ url('admin/exportxlsx') }}">تحميل الإيكسل</button>-->
        <!--</div>-->
    </div>
</form>
