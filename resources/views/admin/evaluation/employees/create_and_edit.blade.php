                ...
                <div class="card-body">
                    ...
                    @if ($item->id)
                        <form class="needs-validation"
                            action="{{ route('admin.evaluation-employees.update', $item->id) }}" method="POST"
                            enctype='multipart/form-data' novalidate>
                            <input type="hidden" name="_method" value="PUT">
                        @else
                            <form class="needs-validation" action="{{ route('admin.evaluation-employees.store') }}"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <input id="price-field" min="0" step="any" type="number" class="form-control @if ($errors->has('price')) is-invalid @endif"
                                    name='price'
                        ...
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-danger pull-right text-white"
                                href="{{ route('admin.evaluation-employees.index') }}">@lang('admin.Cancel') <i
