                ...
                <div class="card-body">
                    ...
                    @if ($item->id)
                        <form class="needs-validation"
                            action="{{ route('admin.evaluation-companies.update', $item->id) }}" method="POST"
                            enctype='multipart/form-data' novalidate>
                            <input type="hidden" name="_method" value="PUT">
                        @else
                            <form class="needs-validation" action="{{ route('admin.evaluation-companies.store') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-danger pull-right text-white"
                                href="{{ route('admin.evaluation-companies.index') }}">@lang('admin.Cancel') <i
