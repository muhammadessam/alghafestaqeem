...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('admin.EvaluationCompanies') <span
                        ...
                        @if (can('evaluation-companies.create'))
                            ...
                            <a class="btn btn-success pull-right text-white"
                                href="{{ route('admin.evaluation-companies.create') }}">
                                <i class=" icon-plus"></i>
                            </a>
                        @endif
                    </h4>
                                            ...
                                            <td class="text-left">
                                                @if (can('evaluation-companies.edit'))
                                                    ...
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('admin.evaluation-companies.edit', $item->id) }}">
                                                        <i class="text-white icon-note"></i>
                                                    </a>
                                                @endif
                                                @if (can('evaluation-companies.destroy'))
                                                    <form
                                                        action="{{ route('admin.evaluation-companies.destroy', $item->id) }}"
