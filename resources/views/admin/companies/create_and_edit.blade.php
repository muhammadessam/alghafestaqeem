        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    @if ($item->id)
                        <form class="needs-validation" action="{{ route('admin.companies.update', $item->id) }}"
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input required id="email-field" type="text" class="form-control @if ($errors->has('email')) is-invalid @endif"
                                        name='email'
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input required id="link-field" type="text" class="form-control @if ($errors->has('link')) is-invalid @endif"
                                        name='link'
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="service_id-field" class="form-control js-example-basic-multiple"
                                            multiple name="service_id[]">

                                            @if (!empty($result['services']))
                                                @foreach ($result['services'] as $service)
                                                    <option
                                                        {{ in_array($service->id, old('service_id', $item->service_ids ?? [])) ? 'selected' : '' }}
                                                        value="{{ $service->id }}">
                                                        {{ $service->title }}
                                                    </option>
                                                @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="active">
                                            <option {{ old('active', $item->active) == '1' ? 'selected' : '' }}
                                                value="1">
                                                @lang('admin.Yes')</option>
                                            <option {{ old('active', $item->active) == '0' ? 'selected' : '' }}
                                                value="0">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input required id="mobile-field" type="text" class="form-control @if ($errors->has('mobile')) is-invalid @endif"
                                        name='mobile'
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <input required id="whats_app-field" type="text" class="form-control @if ($errors->has('whats_app')) is-invalid @endif"
                                        name='whats_app'
                                        value="{{ $item->whats_app ?? old('whats_app') }}" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <textarea id="description-field" rows="15" class="form-control @if ($errors->has('description')) is-invalid @endif"
                        ...
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-danger pull-right text-white"
                                href="{{ route('admin.companies.index') }}">@lang('admin.Cancel') <i
