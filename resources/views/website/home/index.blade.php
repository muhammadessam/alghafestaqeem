            ...
            <div class="inner-container">
                <div class="row clearfix">
                    ...
                    <div class="apps-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <a href="{{ $setting->googlePlay ? $setting->googlePlay : '#' }}"><img
                                    src="{{ asset('/img/googleplay.png') }}" alt=""></a>
                            <a href="{{ $setting->appStore ? $setting->appStore : '#' }}"><img
                                    src="{{ asset('/img/iosstore.png') }}" alt=""></a>
                        </div>
                    </div>
            ...
            <div class="xis-contact-content position-relative" id="xis-contact-content">
                ...
                <div class="xis-btn d-flex justify-content-center">
                    <a class="d-flex justify-content-center align-items-center"
                        href="tel:{{ $setting->phone }}">{{ $setting->phone }} <i class="far fa-arrow-right"></i></a>
                    <a class="d-flex justify-content-center align-items-center" href="{{url('rate-request')}}">طلب تقييم <i
