...
**بتاريخ: 21-01-2024**
**آخر تعديل: 21-01-2024**

إدارة المحتوى يستخدم مكتبة Sky CMS، والذي وجدت فيه عدة مشاكل يتطلب إصلاحها التعديل على الكود المصدري للمكتبة.

سأفوم بفتح عدة PRs لحل المشاكل، إلى ذلك الحين يجب عمل التعديلات التالية عند رفع المشروع على استضافة جديدة أو في حالة إعادة تثبيت المكتبات.

#### 1. يجب استبدال ملف /vendor/lara-zeus/sky/src/Filament/Resources/PostResource.php بالمحتوى التالي
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Tabs::make('post_tabs')->schema([
                ...
                Tabs\Tab::make(__('Tags'))->label(__('Tags and Categories'))->schema([
