...
class EntryEmployeeCountWidget extends ChartWidget
{
    protected static ?string $heading = 'موظفين الادخال';
    ...
    protected function getData(): array
    {
        ...
        })->join('evaluation_employees', 'evaluation_employees.id', 'evaluation_transactions.income_id')
            ->select('evaluation_employees.title', \DB::raw('COUNT(*) as employee_count'))
            ->groupBy('evaluation_transactions.income_id')
