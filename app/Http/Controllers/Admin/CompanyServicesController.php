...
class CompanyServicesController extends Controller
{
    ...
    private $path = 'company-services';
    private $scope = 'CompanyService';
    ...
    public function __construct(ContentRepositoryInterface $contentRepository)
    {
        ...
        $this->middleware('checkPermission:company-services.index')->only(['index']);
        $this->middleware('checkPermission:company-services.show')->only(['show']);
        $this->middleware('checkPermission:company-services.edit')->only(['edit']);
        $this->middleware('checkPermission:company-services.delete')->only(['destroy']);
        $this->middleware('checkPermission:company-services.create')->only(['create']);
    }
